...
public class Tea_grower {
    ...
    private static By txt_Family_Select_one = By.xpath("//label[contains(@id, 'familydlg_label')]");
    ...
    private static By txt_Family_spouse = By.xpath("//li[contains(@id, 'familydlg_1')]");
    ...
    private static By txt_Family_child_one = By.xpath("//li[contains(@id, 'familydlg_2')]");
    ...
    private static By txt_Family_child_two = By.xpath("//li[contains(@id, 'familydlg_3')]");

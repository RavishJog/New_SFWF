...
import static objectrepository.FPS.Title_deed_agreement;
...
//    }
    ...
    @And("^I upload Contract/lease Agreement \"([^\"]*)\"$")
    public void iUploadContractLeaseAgreement(String upload_test) throws Throwable {
        String filePath = new File(upload_test).getAbsolutePath();
    ...
    @And("^I upload Document for selected certificate \"([^\"]*)\"$")
    public void iUploadDocumentForSelectedCertificate(String upload_test) throws Throwable {
        String filePath = new File(upload_test).getAbsolutePath();
        BFSS.Document_for_selected_certificate(driver).sendKeys(filePath);
        WebDriverWait w = new WebDriverWait(driver, 120);
        WebElement element = w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//span[contains(.,'ui-button')])[6]")));
    }

    @And("^I Click to Add crop production Plan$")
    public void iClickToAddCropProductionPlan() {
        try {
            BFSS.crop_production_plan(driver);
        } catch (Exception e) {
            Assert.fail("Crop Production plan is not clickable");
        }
    ...
    public void iVerifyCropProductionPlanFormInputTable() {
        WebDriverWait w = new WebDriverWait(driver, 120);
        WebElement element = w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[contains(.,'Crop Production Plan')])[2]")));
        try {
            BFSS.crop_production_plan_form(driver);
        } catch (Exception e) {
            System.out.println("Crop production Plan form did not appear");
            Assert.fail("Crop production Plan form did not appear");
    ...
    public void iSelectCropCycle(String Crop_cycle) throws Throwable {
        BFSS.select_one_crop_cycle(driver).click();
        Thread.sleep(1500);
        if (Crop_cycle.equals("I")) {
            try {
                BFSS.I(driver).click();
            } catch (Exception e) {
                System.out.println("I is not working");
                Assert.fail("I is not working");
            }
        } else if (Crop_cycle.equals("II")) {
            try {
                BFSS.II(driver).click();
            } catch (Exception e) {
                System.out.println("II is not working");
                Assert.fail("II is not working");
            }
        } else if (Crop_cycle.equals("III")) {
            try {
                BFSS.III(driver).click();
            } catch (Exception e) {
                System.out.println("III is not working");
                Assert.fail("III is not working");
            }
        }
    }
    ...
    public void iClickOnAddDamage() {
        try {
            ...
            Assert.fail("Add Damage is not clickable");
        }
    ...
    public void iVerifyDisplayOfDamageDeclarationInputTable() {

//        driver.switchTo().frame("//div[contains(@id, 'dlgfamily')]");  // Switch to the frame with the specified name or ID

        WebDriverWait w = new WebDriverWait(driver, 120);
        WebElement element = w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(.,'Damage Declaration Form')]")));
        try {
            FPS.Damage_Declaration(driver);
        } catch (Exception e) {
    ...
    @And("^I Input Number of Acreage \"([^\"]*)\"$")
    public void iInputNumberOfAcreage(String number_of_acreage) throws Throwable {
        FPS.Number_of_Acreage(driver).sendKeys(number_of_acreage);
    }


    @And("^I Input Date Planted \"([^\"]*)\"$")
    public void iInputDatePlanted(String date_planted) throws Throwable {
        FPS.date_planted(driver).sendKeys(date_planted);
        WebDriverWait w = new WebDriverWait(driver, 120);

    }


    @And("^I Select SFWF Registration Number \"([^\"]*)\"$")
    public void iSelectSFWFRegistrationNumber(String SFWF_Reg_No) throws Throwable {
        FPS.Select_one_sfwf_reg_no(driver).click();
        if (SFWF_Reg_No.equals("00009F")) {
            try {
                FPS.Option_one_sfwf_ref_no(driver).click();
                WebDriverWait w = new WebDriverWait(driver, 120);
            } catch (Exception e) {
                System.out.println("SFWF Ref Number is not valid");
                Assert.fail("SFWF Ref Number is not valid");
...
//Object for verify display of FPS

    @And("^I Verify Display of Farmers Protection Scheme\\(FPS\\)$")
    public void iVerifyDisplayOfFarmersProtectionSchemeFPS() {
        try {
            sleep(3000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
...
//        driver.switchTo().frame("//div[contains(@id, 'dlgfamily')]");  // Switch to the frame with the specified name or ID
        ...
        WebElement element = w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//h5[1]")));
        try {
            FPS.FPS_Form(driver);
        } catch (Exception e) {
            System.out.println("Farmers Protection Scheme  did not appear");
            Assert.fail("Farmers Protection Scheme did not appear");
        }
    ...
    public void iSelectProductionSystemFPS(String Production_System) throws Throwable {
        ...
        Thread.sleep(1500);
        if (Production_System.equals("Open Field")) {
            FPS.Open_field(driver).click();
            WebDriverWait w = new WebDriverWait(driver, 120);
            WebElement element = w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//li[contains(.,'Open Field')]")));
            System.out.println("Open Field is working fine");
        } else if (Production_System.equals("Sheltered Structured")) {
            FPS.Sheltered_Structured(driver).click();
            System.out.println("Sheltered Structured is working fine");
        } else {
            System.out.println("Production System option is not valid");
            Assert.fail("Production System option is not valid");
        }
    ...
    public void iInputRemarksForFPS(String remarks) throws Throwable {
        ...
        WebDriverWait w = new WebDriverWait(driver, 120);
        WebElement element = w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//textarea[contains(@id,'idt70:remark')]")));
    }

    //@And("^I Click on Save Button \"([^\"]*)\"$")
    // public void iClickOnSaveButton(String save_button) throws Throwable {
    //    FPS.save_button(driver).click();
    //    WebDriverWait w = new WebDriverWait(driver, 120);
    //   WebElement element = w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[normalize-space()='Save']")));
    //}

    //Object for save and continue
    @And("^I Click on Save and Continue for FPS$")
    public void iClickOnSaveAndContinueForFPS() throws InterruptedException {
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", FPS.Save_and_continue_FPS(driver));
        WebDriverWait wait = new WebDriverWait(driver, 120); // 30 seconds timeout
        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(@id,'_next')]")));
        try {
            FPS.Save_and_continue_FPS(driver).click();
        } catch (Exception e) {
            System.out.println("Save and Continue is not working");
    ...
    public void iClickOnSaveButtonForFPS() throws InterruptedException {
        FPS.Save_Button(driver).click();
    ...
    public void iVerifyUploadRequiredDocumentsPageIsDisplayedForFPS() throws InterruptedException {
        WebDriverWait w = new WebDriverWait(driver, 120);
        WebElement element = w.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//h6[contains(.,'Upload Required Documents')]")));
        try {
            FPS.Upload_required_documents(driver);
        } catch (Exception e) {
            System.out.println("Upload Required Documents did not appear");
            Assert.fail("Upload Required Documents did not appear");
        }
    ...
    public void iClickOnIHerebyDeclareThatTheAboveInformationIsTrue() throws InterruptedException {
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(false);", FPS.Above_Information(driver));
        FPS.Above_Information(driver).click();
        Thread.sleep(1500);
    }

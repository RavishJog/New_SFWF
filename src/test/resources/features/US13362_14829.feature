...
@Main_feature @US13362 @GOC
  Feature: User story 13362-GOC - Register as Bio Farming support scheme
    ...
    Scenario Outline:Application to Register as Bio Farming Support Scheme
      ...
      And I Select Type of Farmer "<Farmer_Type>"
      And I Input Type of Farmer BFSS "<small_planter>"
      And I Click on Save and Continue
      And I Verify Display of Type of Agricultural Activities page
      And I click on Add Agricultural Activities
      And I select Type of Operator "<Operator_Type>"
